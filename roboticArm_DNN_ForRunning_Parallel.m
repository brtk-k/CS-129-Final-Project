% Auxillary function for the HyperParameters_Helper_Parallel.m function,
% which allows for parallelized execution of the parameter sweep
function roboticArm_DNN_ForRunning_Parallel(nDOF, trainSetFileName, cvSetFileName, numF, numJ_F, N_iter, L, hidden_layer_size, beta, lambda, zeta)
    ...
    figure(2)
    plot(1:length(Jcost_vector), Jcost_vector)
